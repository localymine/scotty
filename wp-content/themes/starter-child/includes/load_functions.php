...
function omw_theme_enqueue_styles() {
    ...
    wp_enqueue_style('child-style-validator', get_stylesheet_directory_uri() . '/js/bootstrap-validator/css/bootstrapValidator.min.css', array($parent_style)
    );
    
    wp_enqueue_script('child-common', get_stylesheet_directory_uri() . '/js/common.js', array('scrollTo', 'SmoothScroll'), false, true);
    wp_enqueue_script('child-validator', get_stylesheet_directory_uri() . '/js/bootstrap-validator/js/bootstrapValidator.min.js', array('child-common'), false, true);
}
