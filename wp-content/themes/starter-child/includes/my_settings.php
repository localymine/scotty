...
class omw_theme_settings {
    ...
    const DEFAULT_TAB = 'company-info';
    private $page_slug = 'omw-theme-settings';
...
//            $this->settings['ct_google_tag_manager'] = stripslashes(esc_textarea(wp_filter_post_kses($this->settings['ct_google_tag_manager'])));
    ...
    public function omw_admin_tabs($current = self::DEFAULT_TAB) {
        $links = array();
    ...
    public function omw_settings_page() {
        ...
        <div class="wrap">
            ...
            if (isset($_GET['tab']))
                ...
                $this->omw_admin_tabs(self::DEFAULT_TAB);
            ?>
